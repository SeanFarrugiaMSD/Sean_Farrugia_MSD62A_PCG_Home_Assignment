...
public class PyramidGenerator : ParentShapeGenerator
{
    ...
    protected override void GenerateMesh()
    {
        ...
        //Creating FRONT face
        meshGenerator.AddTriangleToMesh(b3, t0, b2, 2);

        //Creating BACK face
        meshGenerator.AddTriangleToMesh(b1, t0, b0, 0);

        //Creating LEFT face
        meshGenerator.AddTriangleToMesh(b0, t0, b3, 4);

        //Creating RIGHT face
        meshGenerator.AddTriangleToMesh(b2, t0, b1, 3);
